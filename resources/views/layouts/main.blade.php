            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse mt-1" id="navbarSupportedContent">
                <ul class="navbar-nav ps-5">
                    ...
                    <li class="nav-item">
                        <div class="nav-hover ps-3 pe-3">
                            <a class="nav-link" href="{{ '/pusatbantuan' }}">Pusat Bantuan</a>
                        </div>
                    </li>
                </ul>
                            ...
                            @else
                                @if(auth()->user()->role == "admin")
                                    <li class="nav-item dropdown">
                                        ...
                                        <li><a class="dropdown-item" href="/admin/"><span class="fa fa-user ms-2 me-3"></span> Admin</a></li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-profile-content">
                                    <li><a class="dropdown-item" href="/penyedia/akomodasi"><span class="fa fa-suitcase ms-2 me-3"></span> Akomodasi</a></li>
                                    <li><a class="dropdown-item" href="/penyedia/pemesanan/ver"><span class="fa fa-envelope-open-text ms-2 me-3"></span>Pemesanan</a></li>
                                    <li><a class="dropdown-item" href="/penyedia/pembayaran"><span class="fa fa-money-check ms-2 me-3"></span> Pembayaran</a></li>
                                    <li><a class="dropdown-item" href="/penyedia/pengaturan"><span class="fa fa-cog ms-2 me-3"></span> Pengaturan</a></li>
                                    <li><a class="dropdown-item" href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                                        document.getElementById('logout-form').submit();"><span class="fa fa-sign-out-alt ms-2 me-3"></span> {{ __('Logout') }}
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-profile-content">
                                    <li><a class="dropdown-item" href="/penyewa/pemesanan/ver"><span class="fa fa-envelope-open-text ms-2 me-3"></span> Penyewaan</a></li>
                                    <li><a class="dropdown-item" href="/penyewa/pembayara   n"><span class="fa fa-money-check ms-2 me-3"></span> Pembayaran</a></li>
                                    <li><a class="dropdown-item" href="/penyewa/pengaturan"><span class="fa fa-cog ms-2 me-3"></span> Settings</a></li>
                                    <li><a class="dropdown-item" href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                                        document.getElementById('logout-form').submit();"><span class="fa fa-sign-out-alt ms-2 me-3"></span> {{ __('Logout') }}
                                    </a>
    ...
    <div class="container">
        ...
        <div class="left second">
            ...
            <ul class ="info">
                ...
                <p><a href="{{ ('pusatbantuan') }}"> Pusat Bantuan</a></p>
                </li>
                <li>
                    <span><i class="fas fa-phone"></i></span>
                    <p><a href="telp. +62812345678910">+62 812 3456 7890</a></p>
                </li>
                <li>
                    <span><i class ="fas fa-envelope" ></i> </span>
                    <p><a href="mail: kelompa12@gmail.com">kelompa12@gmail.com</a></p>
                </li>
            </ul>
        </div>
