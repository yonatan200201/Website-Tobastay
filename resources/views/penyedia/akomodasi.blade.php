      ...
      <section class="content ml-2">
        ...
        <div class="callout callout-info card col-lg-2">
          ...
          <div class="col">
            <div class="card collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Kos saya - sudah diverifikasi</h3>
          ...
          <div class="col">
            <div class="card collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Kos saya - belum diverifikasi</h3>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($kos_notver as $kosnotver)
                        <tr>
                          <td>{{ $kosnotver->id_akomodasi }}</td>
                          <td>{{ $kosnotver->nama_akomodasi }}</td>
                          <td><img src="{{asset('img/res/akomodasi')}}/{{ $kosnotver->img_akomodasi }}" alt="" width="50px" height="50px"></td>
                          <td>{{ $kosnotver->kecamatan }}</td>
                          <td>{{ $kosnotver->alamat }}</td>
                          <td>{{ $kosnotver->deskripsi_akomodasi }}</td>
                          <td>{{ $kosnotver->harga_hari }}</td>
                          <td>{{ $kosnotver->harga_bulan }}</td>
                          <td>{{ $kosnotver->stok }}</td>
                          <td>{{ $kosnotver->ukuran }}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
          ...
          <div class="col">
            <div class="card collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Kontrakan saya - sudah diverifikasi</h3>
          ...
          <div class="col">
            <div class="card collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Kontrakan saya - belum diverifikasi</h3>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($kontrakan_notver as $kontrakannotver)
                        <tr>
                          <td>{{ $kontrakannotver->id_akomodasi }}</td>
                          <td>{{ $kontrakannotver->nama_akomodasi }}</td>
                          <td><img src="{{asset('img/res/akomodasi')}}/{{ $kontrakannotver->img_akomodasi }}" alt="" width="50px" height="50px"></td>
                          <td>{{ $kontrakannotver->kecamatan }}</td>
                          <td>{{ $kontrakannotver->alamat }}</td>
                          <td>{{ $kontrakannotver->deskripsi_akomodasi }}</td>
                          <td>{{ $kontrakannotver->harga_hari }}</td>
                          <td>{{ $kontrakannotver->harga_bulan }}</td>
                          <td>{{ $kontrakannotver->stok }}</td>
                          <td>{{ $kontrakannotver->ukuran }}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
            ...
            <div class="col">
              <div class="card collapsed-card">
                <div class="card-header">
                  <h3 class="card-title">Homestay saya - sudah diverifikasi</h3>
            ...
            <div class="col">
              <div class="card collapsed-card">
                <div class="card-header">
                  <h3 class="card-title">Homestay saya - belum diverifikasi</h3>
