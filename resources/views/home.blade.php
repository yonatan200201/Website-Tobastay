...
@section('wrapper')
    <div class="container py-5 pt-5 col-lg">
        ...
        <div class="col-lg-12 mt-5">
            <div class="container">
                <div class="col-lg-3 pt-3 mx-auto border shadow-sm">
                    <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                        <li class="nav-item ms-2" role="presentation">
                          <button class="nav-link active" id="pills-home-tab" style="width: 120px" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Kos</button>
                        </li>
                        <li class="nav-item ms-2" role="presentation">
                          <button class="nav-link" id="pills-profile-tab" style="width: 120px" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Kontrakan</button>
                        </li>
                      </ul>
                </div>
                            ...
                            <div class="owl-carousel">
                                <div class="testimonial-box p-3">
                                    <div class="d-flex align-items-center ms-3 mt-4 mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><b>Hayati Markotop</b></h5>
                                            <p class="text-muted mb-0">Mahasiswa</p>
                                        </div>
                                    </div>
                                    <p class="ms-3 text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam
